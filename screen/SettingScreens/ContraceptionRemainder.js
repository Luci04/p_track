...
const ContraceptionRemainder = () => {
    ...
    const onToggleSwitch = async (data) => {
        ...
        if (data) {
            ...
            await notifee.deleteChannel('ContraceptionRemainderNotification');
    ...
    const handleConfirm = async (date) => {
        ...
        await storeDataItem('ContraceptionRemainderNotification', moment(date).format('LT'));
        ...
        <View style={styles.containerStyle}>
            <View style={styles.optionContainer}>
                <View style={styles.rowContainer}>
                    ...
                    <Text style={styles.optionSubtitle}>Empowering Your Choices, Every Day</Text>
                </View>
